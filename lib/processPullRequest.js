...
var processPullRequest = function processPullRequest(_ref2) {
  ...
  return files(owner, repo, number).then(function (files) {
    ...
    return (0, _flatMap2.default)([function (files) {
      return console.log('--- processing files:', files.map(function (f) {
        return f.filename;
      })) || [];
    }(files), (0, _eslintAdapter2.default)(fetchContent)(files), (0, _stylelintAdapter2.default)(fetchContent)(files)]);
